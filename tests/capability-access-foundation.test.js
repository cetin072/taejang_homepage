...
test('browser capability bridge is a Core dependency and fails closed without v2 access', () => {
  ...
  assert.doesNotMatch(bridge, /keeping legacy route guards|isMissingV2/);
});
