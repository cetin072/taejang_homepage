...
assert.match(index, /사람에게 맞는 일을 만들고,<br>오래 이어갑니다/);
assert.match(index, /태장은 사람의 강점에 맞는 직무를 설계하고 운영하는 자회사형 장애인 표준사업장입니다\./);
...
assert.equal((index.match(/지속 가능한/g) || []).length, 0, 'Preview Hero 메시지에는 기존 지속 가능한 표현을 남기지 않습니다');
