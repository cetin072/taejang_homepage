...
assert.equal(items.length, 30, '2026-09-14 공식 블로그 공개 글 totalCount=30과 일치해야 합니다');
...
assert.equal(items[0].id, 'naver-blog-224400618229');
assert.equal(items[0].publishedAt, '2026-09-11');
