...
-- Keep the employee-number sequence aligned with already-created employee IDs.
-- Sequence increments are not transactional, and historical/manual imports may have advanced IDs independently.
select setval(
