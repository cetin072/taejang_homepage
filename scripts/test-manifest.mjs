export const testGroups = Object.freeze({
  platformStatic: Object.freeze([
    ...
    'tests/issue-223-promotion-meta-stale-response.test.js',
  ...
  payrollRegression: Object.freeze([
    ...
    'tests/payroll-draft-handoff.test.js',
    ...
    'tests/payroll-monthly-attendance-workbook.test.js',
    ...
    'tests/payroll-vendor-source-snapshot-persistence.test.js',
    'tests/payroll-attendance-exception-reason-context.test.js',
