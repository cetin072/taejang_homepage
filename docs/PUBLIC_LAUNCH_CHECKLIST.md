...
`환경정비·ESG 현장 운영`은 단순 봉사활동이 아니라 기업·기관이 의뢰할 수 있는 현장 운영 용역으로 안내합니다.
...
현장 규모와 조건에 따라 보통 2~3주 동안 준비하며, 메인페이지와 `partnership.html#environment-service`에서 의뢰 가능 업무로 안내합니다.
